...
Next as we go up in the sky, we build on the base to from increasingly vague, but more valuable points that build on each other, until ultimately to an over all goal or vision. 
